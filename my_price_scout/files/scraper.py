...
if __name__ == '__main__':
    ...
    # Scraper().scrape_amazon('https://www.amazon.com/APC-Battery-Protector-BackUPS-BX1500M/dp/B06VY6FXMM?ref_=Oct_DLandingS_D_d1d1e0d6_60&smid=ATVPDKIKX0DER&th=1')
    ...
    #     'https://www.bestbuy.com/site/tcl-40-class-3-series-led-full-hd-smart-roku-tv/6302321.p?skuId=6302321')
    # Scraper().scrape_bestbuy(
    #     'https://www.bestbuy.com/site/insignia-insignia-cd-boombox-black/9183279.p?skuId=9183279')
    # Scraper().scrape_bestbuy(
    #     'https://www.bestbuy.com/site/ecovacs-robotics-deebot-t8-vacuum-mop-robot-with-advanced-laser-mapping-and-3d-obstacle-detection-avoidance-grey/6423195.p?skuId=6423195')
    # Scraper().scrape_bestbuy(
    #     'https://www.bestbuy.com/site/apple-10-2-inch-ipad-latest-model-with-wi-fi-64gb-space-gray/4901809.p?skuId=4901809')
    # Scraper().scrape_bestbuy(
    #     'https://www.bestbuy.com/site/lg-27-cu-ft-side-by-side-smart-refrigerator-with-craft-ice-and-instaview-stainless-steel/6468484.p?skuId=6468484')
    # Scraper().scrape_bestbuy(
    #     'https://www.bestbuy.com/site/lg-5-5-cu-ft-smart-top-load-washer-with-turbowash3d-white/6492268.p?skuId=6492268')
